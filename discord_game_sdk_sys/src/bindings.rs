...
pub type EDiscordResult = crate::ctypes::c_uint;
...
pub type EDiscordCreateFlags = crate::ctypes::c_uint;
...
pub type EDiscordLogLevel = crate::ctypes::c_uint;
...
pub type EDiscordUserFlag = crate::ctypes::c_uint;
...
pub type EDiscordPremiumType = crate::ctypes::c_uint;
pub const DiscordImageType_User: EDiscordImageType = 0;
pub type EDiscordImageType = crate::ctypes::c_uint;
...
pub type EDiscordActivityType = crate::ctypes::c_uint;
...
pub type EDiscordActivityActionType = crate::ctypes::c_uint;
...
pub type EDiscordActivityJoinRequestReply = crate::ctypes::c_uint;
...
pub type EDiscordStatus = crate::ctypes::c_uint;
...
pub type EDiscordLobbySearchComparison = crate::ctypes::c_int;
...
pub type EDiscordLobbySearchCast = crate::ctypes::c_uint;
...
pub type EDiscordLobbySearchDistance = crate::ctypes::c_uint;
...
pub type EDiscordEntitlementType = crate::ctypes::c_uint;
...
pub type EDiscordSkuType = crate::ctypes::c_uint;
...
pub type EDiscordInputModeType = crate::ctypes::c_uint;
...
pub type DiscordLocale = [crate::ctypes::c_char; 128usize];
pub type DiscordBranch = [crate::ctypes::c_char; 4096usize];
pub type DiscordLobbyId = DiscordSnowflake;
pub type DiscordLobbySecret = [crate::ctypes::c_char; 128usize];
pub type DiscordMetadataKey = [crate::ctypes::c_char; 256usize];
pub type DiscordMetadataValue = [crate::ctypes::c_char; 4096usize];
pub type DiscordNetworkPeerId = u64;
pub type DiscordNetworkChannelId = u8;
pub type DiscordPath = [crate::ctypes::c_char; 4096usize];
pub type DiscordDateTime = [crate::ctypes::c_char; 64usize];
#[repr(C)]
#[derive(Copy, Clone)]
pub struct DiscordUser {
    pub id: DiscordUserId,
    pub username: [crate::ctypes::c_char; 256usize],
    pub discriminator: [crate::ctypes::c_char; 8usize],
    pub avatar: [crate::ctypes::c_char; 128usize],
    pub bot: bool,
}
#[test]
...
pub struct DiscordOAuth2Token {
    pub access_token: [crate::ctypes::c_char; 128usize],
    pub scopes: [crate::ctypes::c_char; 1024usize],
...
pub struct DiscordActivityAssets {
    pub large_image: [crate::ctypes::c_char; 128usize],
    pub large_text: [crate::ctypes::c_char; 128usize],
    pub small_image: [crate::ctypes::c_char; 128usize],
    pub small_text: [crate::ctypes::c_char; 128usize],
}
#[test]
...
pub struct DiscordActivityParty {
    pub id: [crate::ctypes::c_char; 128usize],
...
pub struct DiscordActivitySecrets {
    pub match_: [crate::ctypes::c_char; 128usize],
    pub join: [crate::ctypes::c_char; 128usize],
    pub spectate: [crate::ctypes::c_char; 128usize],
}
#[test]
...
pub struct DiscordActivity {
    ...
    pub state: [crate::ctypes::c_char; 128usize],
    pub details: [crate::ctypes::c_char; 128usize],
...
pub struct DiscordFileStat {
    pub filename: [crate::ctypes::c_char; 260usize],
    pub size: u64,
...
pub struct DiscordSkuPrice {
    pub amount: u32,
    pub currency: [crate::ctypes::c_char; 16usize],
}
#[test]
...
pub struct DiscordInputMode {
    ...
    pub shortcut: [crate::ctypes::c_char; 256usize],
}
#[test]
...
pub type IDiscordApplicationEvents = *mut crate::ctypes::c_void;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, Hash, PartialEq, Eq)]
pub struct IDiscordApplicationManager {
    pub validate_or_exit: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            callback_data: *mut crate::ctypes::c_void,
...
pub struct IDiscordUserEvents {
    pub on_current_user_update:
        ::std::option::Option<unsafe extern "C" fn(event_data: *mut crate::ctypes::c_void)>,
}
#[test]
...
pub type IDiscordImageEvents = *mut crate::ctypes::c_void;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, Hash, PartialEq, Eq)]
...
pub struct IDiscordActivityEvents {
    pub on_activity_join: ::std::option::Option<
        unsafe extern "C" fn(
            event_data: *mut crate::ctypes::c_void,
            secret: *const crate::ctypes::c_char,
        ),
    >,
    ...
    pub on_activity_join_request: ::std::option::Option<
        unsafe extern "C" fn(event_data: *mut crate::ctypes::c_void, user: *mut DiscordUser),
    >,
...
pub struct IDiscordActivityManager {
    pub register_command: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            command: *const crate::ctypes::c_char,
        ) -> EDiscordResult,
    >,
    ...
    pub send_invite: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            user_id: DiscordUserId,
            type_: EDiscordActivityActionType,
            content: *const crate::ctypes::c_char,
            callback_data: *mut crate::ctypes::c_void,
            callback: ::std::option::Option<
                unsafe extern "C" fn(
                    callback_data: *mut crate::ctypes::c_void,
...
pub struct IDiscordRelationshipManager {
    pub filter: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            filter_data: *mut crate::ctypes::c_void,
...
pub struct IDiscordLobbyEvents {
    pub on_lobby_update: ::std::option::Option<
        unsafe extern "C" fn(event_data: *mut crate::ctypes::c_void, lobby_id: i64),
    >,
    pub on_lobby_delete: ::std::option::Option<
        unsafe extern "C" fn(event_data: *mut crate::ctypes::c_void, lobby_id: i64, reason: u32),
    >,
    pub on_member_connect: ::std::option::Option<
        unsafe extern "C" fn(event_data: *mut crate::ctypes::c_void, lobby_id: i64, user_id: i64),
    >,
...
pub struct IDiscordLobbyManager {
    ...
    pub connect_lobby: ::std::option::Option<
        unsafe extern "C" fn(
            manager: *mut IDiscordLobbyManager,
            lobby_id: DiscordLobbyId,
            secret: *mut crate::ctypes::c_char,
            callback_data: *mut crate::ctypes::c_void,
            callback: ::std::option::Option<
                unsafe extern "C" fn(
                    callback_data: *mut crate::ctypes::c_void,
    ...
    pub connect_lobby_with_activity_secret: ::std::option::Option<
        unsafe extern "C" fn(
            manager: *mut IDiscordLobbyManager,
            activity_secret: *mut crate::ctypes::c_char,
            callback_data: *mut crate::ctypes::c_void,
            callback: ::std::option::Option<
                unsafe extern "C" fn(
                    callback_data: *mut crate::ctypes::c_void,
...
pub struct IDiscordNetworkEvents {
    ...
    pub on_route_update: ::std::option::Option<
        unsafe extern "C" fn(
            event_data: *mut crate::ctypes::c_void,
            route_data: *const crate::ctypes::c_char,
        ),
    >,
}
#[test]
...
pub struct IDiscordOverlayEvents {
    pub on_toggle: ::std::option::Option<
        unsafe extern "C" fn(event_data: *mut crate::ctypes::c_void, locked: bool),
    >,
}
#[test]
...
pub struct IDiscordOverlayManager {
    ...
    pub open_guild_invite: ::std::option::Option<
        unsafe extern "C" fn(
            manager: *mut IDiscordOverlayManager,
            code: *const crate::ctypes::c_char,
            callback_data: *mut crate::ctypes::c_void,
            callback: ::std::option::Option<
                unsafe extern "C" fn(
                    callback_data: *mut crate::ctypes::c_void,
...
pub type IDiscordStorageEvents = *mut crate::ctypes::c_void;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, Hash, PartialEq, Eq)]
...
pub type IDiscordCoreEvents = *mut crate::ctypes::c_void;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, Hash, PartialEq, Eq)]
pub struct IDiscordCore {
    ...
    pub set_log_hook: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            hook_data: *mut crate::ctypes::c_void,
...
pub struct DiscordCreateParams {
    ...
    pub event_data: *mut crate::ctypes::c_void,
